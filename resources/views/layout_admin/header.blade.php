    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img style="background-color: #ffffff" src="{{ asset('images/icon/ThaiTuan.jpg') }}" class="img-circle" alt="User Image" />
            </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class=" treeview">
                <a href="{{ route('companies.index') }}">
                    ...
                    <span style="font-size:16px ;">{{ __('Nhà Xuất Bản') }}</span>
                </a>
            </li>
            @endcan
            <!-- CRUD  sách -->
            ...
            <li class=" treeview">
                <a href="{{ route('book.index') }}">
                    ...
                    <span style="font-size:16px ;"> {{ __('Danh Sách') }}</span>
                </a>
            ...
            <li class="treeview">
                <a href="{{ route('book_type.index') }}">
                    ...
                    <span style="font-size:16px ;"> {{ __('Danh Sách Thể Loại') }}</span>
                </a>
            </li>   
            <li class="header ">
            ...
            <li class="treeview">
                <a href="{{ route('bill.index') }}">
                    ...
                    <span style="font-size:16px ;">{{ __('Hóa Đơn') }}</span>
                </a>
            </li>
            <!-- Quản lý kho hàng -->
            <li class="treeview">
                <a>
                    ...
                    <span style="font-size:16px ;"> {{ __('Cửa Hàng') }}</span>
                    <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu" style="display: none;">
                    <li> <a href="{{ route('store.index') }}"><i class="fa fa-list-alt"></i> {{ __('Cửa Hàng') }} </a></li>
                </ul>
            </li>
            @endif
            @can('admin')
            ...
            <li class="treeview">
                <a href="{{ route('user.index') }}">
                    ...
                    <span style="font-size:16px ;"> {{ __('Tài Khoản') }}</span>
            ...
            <li class="treeview">
                <a href="{{ route('member.index') }}">
                    ...
                    <span style="font-size:16px ;"> {{ __('Người Dùng') }}</span>
            ...
            <li class="treeview">
                <a href="{{ url('logout') }}">
                    ...
                    <span style="font-size:16px ;">{{ __('Thoát') }}</span>
